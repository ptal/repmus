...
public class MidiFile extends Simple_L_MO {
	...
	class MidiNote {
		...
		MidiNote (long s, long e, int m, int v, int t) {
			start = s;
			end = e;
			midic = m;
			vel = v;
	...
	public I_Drawable makeDrawable (MusicalParams params) {
			return new MidiFileDrawable (this, params, 0);
	}
	...
	//////////////////////////////////////////////////
	 public static void convertMidi2RealTime(Sequence seq) {
	        ...
	        int lastTick = 0;
	        int count = 0;
	        List<List<MidiNote>> rep  = new ArrayList<List<MidiNote>> (); 
	...
	public static class MidiFileEditor extends MusicalEditor {
	    ...
	    public MidiFileDrawable (MidiFile theRef, MusicalParams params, int thestaffnum) {
